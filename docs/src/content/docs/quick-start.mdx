...
and offers to turn on the opt-in Test / Docs families. Run it
through whichever agent you installed:
...
claude /heal-code-patch      # drain T0 mechanically: one fix per commit, in Tier / Severity / family-local score order; never pushes or amends.
